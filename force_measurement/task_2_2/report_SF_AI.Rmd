---
title: "SF, LR AI DW | Measurement 1 (24H WD) vs Measurement 3 (SSR, Conivaptan) groups: Bayesian regression of smoothed stretch forces"
...
> **Stretch‑force experiments with symmetric Measurement 1 (24H WD) vs Measurement 3 (SSR, Conivaptan) groups**  
...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "_check_prior_task_2_2.rds"),
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed, 
                   cores = my.cores,
                   file = paste0(rds_folder_name, "model_summary_task_2_2.rds"),
                   file_refit = "on_change")
summary(std.fit)
