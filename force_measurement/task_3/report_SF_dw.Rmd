---
title: "SF, LR dW DW | WD vs Sp  groups: Bayesian regression of smoothed stretch forces"
...
myname <- "SF 0-2 span=0.4 (24H WD, Sp)"
...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "dw_check_prior_task_3.rds"),
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed, 
                   cores = my.cores,
                   file = paste0(rds_folder_name, "dw_model_summary_task_3.1.rds"),
                   file_refit = "on_change")
summary(std.fit)
...
myname <- "SF span=0.4 0-2 CI dW WD vs Sp"
