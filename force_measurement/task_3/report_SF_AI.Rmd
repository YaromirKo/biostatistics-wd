---
title: "SF, LR AI DW | 24WD vs Sp groups: Bayesian regression of smoothed stretch forces"
...
> **Stretch‑force experiments with symmetric 24WD vs Sp groups**  
...
std.prior <- brm(
  ...
  iter = 4e4,
  sample_prior = "only",
  file = paste0(rds_folder_name, "_check_prior_task_3.rds"),
...
std.fit <-  update(std.prior, 
                   ...
                   seed = my.seed, 
                   cores = my.cores,
                   file = paste0(rds_folder_name, "model_summary_task_3.1.rds"),
                   file_refit = "on_change")
summary(std.fit)
...
myname <- "SF span=0.4 0-2 CI AI WD Sp"
